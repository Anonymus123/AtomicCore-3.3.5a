...
) ENGINE=InnoDB AUTO_INCREMENT=3072 DEFAULT CHARSET=utf8 COMMENT='Account System';
...
-- ----------------------------
-- Table structure for `account_donation`
-- ----------------------------
DROP TABLE IF EXISTS `account_donation`;
