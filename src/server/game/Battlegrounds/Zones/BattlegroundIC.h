...
enum creaturesIC
{
    ...
    NPC_TRIGGER_TELEPORT_OUT = 22515,
    NPC_TRIGGER_TELEPORT_IN = 23472 
};
...
enum BG_IC_NPCs
{
    ...
    BG_IC_NPC_TRIGGER_TELEPORT_HORDE_OUT_1,
    BG_IC_NPC_TRIGGER_TELEPORT_HORDE_OUT_2,
    BG_IC_NPC_TRIGGER_TELEPORT_HORDE_OUT_3,
    BG_IC_NPC_TRIGGER_TELEPORT_ALLIANCE_OUT_1,
    ...
    BG_IC_NPC_TRIGGER_TELEPORT_HORDE_IN_3,
    BG_IC_NPC_TRIGGER_TELEPORT_ALLIANCE_IN_1,
    BG_IC_NPC_TRIGGER_TELEPORT_ALLIANCE_IN_2,
    BG_IC_NPC_TRIGGER_TELEPORT_ALLIANCE_IN_3,
...
enum BG_IC_MaxSpawns
{
    ...
    MAX_NORMAL_NPCS_SPAWNS = BG_IC_NPC_KEEP_CANNON_25+13,
...
const ICNpc BG_IC_NpcSpawnlocs[MAX_NORMAL_NPCS_SPAWNS]=
{
    ...
    {BG_IC_NPC_TRIGGER_TELEPORT_HORDE_OUT_1, NPC_TRIGGER_TELEPORT_OUT, TEAM_NEUTRAL, 1120.43f, -762.11f, 47.92f, 2.94f},
    {BG_IC_NPC_TRIGGER_TELEPORT_HORDE_OUT_2, NPC_TRIGGER_TELEPORT_OUT, TEAM_NEUTRAL, 1218.82f, -864.58f, 48.85f, 4.93f},
    {BG_IC_NPC_TRIGGER_TELEPORT_HORDE_OUT_3, NPC_TRIGGER_TELEPORT_OUT, TEAM_NEUTRAL, 1218.01f, -658.29f, 47.86f, 1.52f},
    {BG_IC_NPC_TRIGGER_TELEPORT_ALLIANCE_OUT_1, NPC_TRIGGER_TELEPORT_OUT, TEAM_NEUTRAL, 442.24f, -835.25f, 44.30f, 0.06f},
    {BG_IC_NPC_TRIGGER_TELEPORT_ALLIANCE_OUT_2, NPC_TRIGGER_TELEPORT_OUT, TEAM_NEUTRAL, 352.15f, -737.57f, 49.09f, 1.56f},
    {BG_IC_NPC_TRIGGER_TELEPORT_ALLIANCE_OUT_3, NPC_TRIGGER_TELEPORT_OUT, TEAM_NEUTRAL, 349.92f, -926.23f, 48.54f, 4.78f},
    {BG_IC_NPC_TRIGGER_TELEPORT_HORDE_IN_1, NPC_TRIGGER_TELEPORT_IN, TEAM_NEUTRAL, 1174.85f, -763.24f, 48.72f, 6.26f},
    {BG_IC_NPC_TRIGGER_TELEPORT_HORDE_IN_2, NPC_TRIGGER_TELEPORT_IN, TEAM_NEUTRAL, 1217.78f, -827.49f, 48.91f, 1.64f},
    {BG_IC_NPC_TRIGGER_TELEPORT_HORDE_IN_3, NPC_TRIGGER_TELEPORT_IN, TEAM_NEUTRAL, 1218.13f, -698.13f, 48.92f, 4.95f},
    {BG_IC_NPC_TRIGGER_TELEPORT_ALLIANCE_IN_1, NPC_TRIGGER_TELEPORT_IN, TEAM_NEUTRAL, 389.57f, -832.38f, 48.65f, 3.00f},
    {BG_IC_NPC_TRIGGER_TELEPORT_ALLIANCE_IN_2, NPC_TRIGGER_TELEPORT_IN, TEAM_NEUTRAL, 350.55f, -789.15f, 48.91f, 4.72f},
    {BG_IC_NPC_TRIGGER_TELEPORT_ALLIANCE_IN_3, NPC_TRIGGER_TELEPORT_IN, TEAM_NEUTRAL, 351.13f, -876.23f, 48.91f, 1.57f},
};
