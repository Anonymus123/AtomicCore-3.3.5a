...
#define DEFAULT_VISIBILITY_INSTANCE 120.0f                  // default visible distance in instances, 170 yards
#define DEFAULT_VISIBILITY_BGARENAS 180.0f                  // default visible distance in BG/Arenas, roughly 533 yards
