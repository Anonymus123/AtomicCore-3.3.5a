...
void AddCustomScripts()
{
    ...
    AddSC_EventTeleporter();
    AddSC_custom_headhunter();
    AddSC_custom_cs_headhunter();
    AddSC_custom_hochzeit_npc();
    AddSC_item_vip();
    AddSC_gh_commandscript();
    AddSC_cs_fk();
	AddSC_npc_code_system();
    //Verließ Neu
    //AddSC_boss_abbadon();
    //AddSC_trash_verlies_neu();
    //AddSC_boss_hauptmann_lanzrath();
    //AddSC_boss_teufelsdrache();
    //AddSC_instance_verlies_neu();
    //AddSC_npc_wache_thomas();
#endif
}
