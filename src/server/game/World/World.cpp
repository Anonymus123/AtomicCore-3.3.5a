...
void World::LoadConfigSettings(bool reload)
{
 ...
 rate_values[RATE_XP_QUEST_PREMIUM]   = ConfigMgr::GetFloatDefault("Rate.XP.Quest.Premium", 1.0f);   }
	...
	rate_values[RATE_XP_WEEKEND_KILL]  = ConfigMgr::GetFloatDefault("Rate.XP.Weekend.Kill", 1.5f);
	rate_values[RATE_XP_WEEKEND_QUEST]  = ConfigMgr::GetFloatDefault("Rate.XP.Weekend.Quest", 1.5f);
	rate_values[RATE_XP_WEEKEND_EXPLORE]  = ConfigMgr::GetFloatDefault("Rate.XP.Weekend.Explore", 1.5f);
    ...
    m_worldChatChannelName = ConfigMgr::GetStringDefault("Channel.WorldChat.ChannelName","world");
    m_worldChatOwnerGuid = ConfigMgr::GetIntDefault("Channel.WorldChat.OwnerGUID",1);
    m_worldChatIdleGuid = ConfigMgr::GetIntDefault("Channel.WorldChat.IdleGUID",2);
...
bool World::UpdateCharacterNameData(uint32 guid, const std::string& name, uint8 gender, uint8 race)
{
