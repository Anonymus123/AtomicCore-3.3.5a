...
enum Rates
{
    ...
    RATE_MOVESPEED,
	RATE_XP_WEEKEND_KILL,
	RATE_XP_WEEKEND_QUEST,
	RATE_XP_WEEKEND_EXPLORE,
    MAX_RATES
};
...
class World
{
    public:
        ...
        bool UpdateCharacterNameData(uint32 guid, const std::string& name, uint8 gender = GENDER_NONE, uint8 race = RACE_NONE);
