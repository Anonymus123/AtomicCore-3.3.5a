...
enum eEnums
{
    ...
    SPELL_SUMMON_SARTHARION_TWILIGHT_WHELP      = 58826,
...
Waypoint m_aTene[]=
{
    {3212.854f, 575.597f, 109.856f},
    {3246.425f, 565.367f, 61.249f}
};
...
public:
    ...
    struct boss_sartharionAI : public ScriptedAI
    {
        ...
        {
            if (me->HasLootMode(LOOT_MODE_HARD_MODE_2))
                me->AddLootMode(LOOT_MODE_HARD_MODE_3);
            else if (me->HasLootMode(LOOT_MODE_HARD_MODE_1))
    ...
    struct mob_acolyte_of_vesperonAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* /*killer*/)
        {
            ...
            if (instance)
            {
                ...
                instance->DoRemoveAurasDueToSpellOnPlayers(58835);
            }
        }
