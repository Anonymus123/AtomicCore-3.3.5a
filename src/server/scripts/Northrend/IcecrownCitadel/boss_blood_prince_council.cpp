...
enum Spells
{
    ...
    SPELL_SHADOW_LANCE_10_N             = 71405,
    SPELL_SHADOW_LANCE_25_N             = 72804,
    SPELL_SHADOW_LANCE_10_H             = 72805,
    SPELL_SHADOW_LANCE_25_H             = 72806,
    SPELL_EMPOWERED_SHADOW_LANCE_10_N   = 71815,
    SPELL_EMPOWERED_SHADOW_LANCE_25_N   = 72809,
    SPELL_EMPOWERED_SHADOW_LANCE_10_H   = 72810,
    SPELL_EMPOWERED_SHADOW_LANCE_25_H   = 72811,
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_SHADOW_LANCE:
                            if (_isEmpowered)
                                DoCastVictim(RAID_MODE(SPELL_EMPOWERED_SHADOW_LANCE_10_N, SPELL_EMPOWERED_SHADOW_LANCE_25_N, SPELL_EMPOWERED_SHADOW_LANCE_10_H, SPELL_EMPOWERED_SHADOW_LANCE_25_H));
                            else
                                DoCastVictim(RAID_MODE(SPELL_SHADOW_LANCE_10_N, SPELL_SHADOW_LANCE_25_N, SPELL_SHADOW_LANCE_10_H, SPELL_SHADOW_LANCE_25_H));
                            events.ScheduleEvent(EVENT_SHADOW_LANCE, 2000);
                            break;
                        default:
                            break;
