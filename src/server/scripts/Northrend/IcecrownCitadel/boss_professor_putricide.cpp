...
enum Events
{
    ...
    EVENT_BERSERK               = 6,
    EVENT_SLIME_PUDDLE          = 7,
    EVENT_UNSTABLE_EXPERIMENT   = 8,
    EVENT_TEAR_GAS              = 9,
    ...
    public:
        ...
        struct boss_professor_putricideAI : public BossAI
        {
            ...
            void EnterCombat(Unit* who)
            {
                ...
                events.ScheduleEvent(EVENT_UNSTABLE_EXPERIMENT, urand(40000, 45000));
                if (IsHeroic())
                ...
                switch (action)
                {
                    ...
                    case ACTION_ROTFACE_OOZE:
                        ...
                        if (Creature* dummy = Unit::GetCreature(*me, _oozeFloodDummyGUIDs[_oozeFloodStage]))
                            dummy->CastSpell(dummy, oozeFloodSpells[_oozeFloodStage], true, NULL, NULL, me->GetGUID());
                    ...
                    switch (eventId)
                    {
                        ...
                        case EVENT_FESTERGUT_GOO:
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0, NonTankTargetSelector(me)))
                                DoCast(target, SPELL_MALLABLE_GOO_H, true);
                            events.ScheduleEvent(EVENT_FESTERGUT_GOO, urand(15000, 20000), 0, PHASE_FESTERGUT);
                            break;
                        ...
                        case EVENT_ROTFACE_VILE_GAS:
                            if (Unit* target = SelectTarget(SELECT_TARGET_RANDOM, 0, NonTankTargetSelector(me)))
                                DoCast(target, SPELL_VILE_GAS_H, true);
                            events.ScheduleEvent(EVENT_ROTFACE_VILE_GAS, urand(15000, 20000), 0, PHASE_ROTFACE);
                            break;
    ...
    public:
        ...
        class spell_putricide_ooze_channel_SpellScript : public SpellScript
        {
            ...
            void StartAttack()
            {
                ...
                GetCaster()->AddThreat(GetHitUnit(), 500000000.0f);
            }
