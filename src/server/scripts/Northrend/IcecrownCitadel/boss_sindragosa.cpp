            ...
            void MovementInform(uint32 type, uint32 point)
            {
                ...
                switch (point)
                {
                    ...
                    case POINT_AIR_PHASE:
                        ...
                        events.ScheduleEvent(EVENT_FROST_BOMB, 13000, EVENT_GROUP_SPECIAL);
                        break;
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_FROST_BOMB:
                        {
                            ...
                            events.ScheduleEvent(EVENT_FROST_BOMB, urand(6000, 8000), EVENT_GROUP_SPECIAL);
                            break;
                        }
                        case EVENT_LAND:
                        {
