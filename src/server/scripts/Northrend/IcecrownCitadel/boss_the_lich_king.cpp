...
enum Events
{
    ...
    EVENT_LIFE_SIPHON               = 25,
    EVENT_START_ATTACK              = 26,
    EVENT_QUAKE_2                   = 27,
    EVENT_VILE_SPIRITS              = 28,
    EVENT_HARVEST_SOULS             = 29,
    EVENT_BERSERK                   = 30,
    EVENT_SOUL_RIP                  = 31,
...
Position const SpiritWardenSpawn  = {539.1f, -2513.0f, 1042.6f, 2.8f};
Position const TerenasSpawn       = {508.4f, -2506.2f, 1042.6f, 6.0f};
Position const TerenasSpawnHeroic = {508.4f, -2506.2f, 1042.6f, 6.0f};
            ...
            void MovementInform(uint32 type, uint32 pointId)
            {
                ...
                switch (pointId)
                {
                    ...
                    case POINT_CENTER_1:
                        ...
                        events.DelayEvents(62500, EVENT_GROUP_BERSERK);
                        ...
                        case EVENT_FROSTMOURNE_HEROIC:
                            if (TempSummon* terenas = me->GetMap()->SummonCreature(NPC_TERENAS_MENETHIL_FROSTMOURNE_H, TerenasSpawnHeroic, NULL, 50000))
                            {
                                ...
                                if (!triggers.empty())
                                {
                                    ...
                                    spawner->CastSpell(spawner, SPELL_SUMMON_SPIRIT_BOMB_1, true);
                                    spawner->CastSpell(spawner, SPELL_SUMMON_SPIRIT_BOMB_2, true);
