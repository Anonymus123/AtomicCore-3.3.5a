...
{
    {NPC_INFILTRATOR_MINCHAR,         {QUEST_DEPROGRAMMING_10,                 QUEST_DEPROGRAMMING_25                }},
    {NPC_KOR_KRON_LIEUTENANT,         {QUEST_SECURING_THE_RAMPARTS_10,         QUEST_SECURING_THE_RAMPARTS_25        }},
    {NPC_FROST_GIANT,                 {QUEST_SECURING_THE_RAMPARTS_10,         QUEST_SECURING_THE_RAMPARTS_25        }},
    {NPC_FROST_GIANT,                 {QUEST_SECURING_THE_RAMPARTS_10,         QUEST_SECURING_THE_RAMPARTS_25        }},
    {NPC_ALCHEMIST_ADRIANNA,          {QUEST_RESIDUE_RENDEZVOUS_10,            QUEST_RESIDUE_RENDEZVOUS_25           }},
    {NPC_ALRIN_THE_AGILE,             {QUEST_BLOOD_QUICKENING_10,              QUEST_BLOOD_QUICKENING_25             }},
    {NPC_INFILTRATOR_MINCHAR_BQ,      {QUEST_BLOOD_QUICKENING_10,              QUEST_BLOOD_QUICKENING_25             }},
    {NPC_MINCHAR_BEAM_STALKER,        {QUEST_BLOOD_QUICKENING_10,              QUEST_BLOOD_QUICKENING_25             }},
    {NPC_VALITHRIA_DREAMWALKER_QUEST, {QUEST_RESPITE_FOR_A_TORNMENTED_SOUL_10, QUEST_RESPITE_FOR_A_TORNMENTED_SOUL_25}},
};
        ...
        struct instance_icecrown_citadel_InstanceMapScript : public InstanceScript
        {
            ...
            uint64 GetData64(uint32 type)
            {
                switch (type)
                {
                    ...
                    case GO_HORDE_TELEPORTER:
                        return HordeTeleportGUID;
                    case DATA_FROSTRIESE:
                        return FrostrieseGUID;
                    case DATA_FESTERGUT:
            ...
            bool SetBossState(uint32 type, EncounterState state)
            {
                ...
                switch (type)
                {
                    ...
                    case DATA_FROSTRIESE:
                        if (state == DONE)
                        {
                            SetBossState(DATA_GUNSHIP_EVENT, DONE);
                        }
                        break;
                    case DATA_FESTERGUT:
                        if (state == DONE)
...
//                      // no break
            ...
            void Load(const char* str)
            {
                ...
                if (dataHead1 == 'I' && dataHead2 == 'C')
                {
                    ...
                    loadStream >> temp;
                    BloodQuickeningState = temp ? DONE : NOT_STARTED;
            ...
            void ProcessEvent(WorldObject* /*source*/, uint32 eventId)
            {
                switch (eventId)
                {
                    ...
                    case EVENT_SECOND_REMORSELESS_WINTER:
                        ...
                        break;
                    case EVENT_TELEPORT_TO_FROSMOURNE:
            ...
            void PrepareGunshipEvent(Player* player)
            {
                ...
                if(TeamInInstance == ALLIANCE)
                {
                    SetBossState(DATA_FROSTRIESE, DONE);
        ...
        protected:
            ...
            uint64 DeathbringerSaurfangEventGUID;
            uint64 DeathbringersCacheGUID;
            uint64 SaurfangTeleportGUID;
            uint64 FrostrieseGUID;
            uint64 HordeTeleportGUID;
