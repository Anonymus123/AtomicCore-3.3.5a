...
enum eFloppy
{
    ...
    SPELL_MRFLOPPY              = 47184,
    SAY_WORGHAGGRO1             = -1800001,
    SAY_WORGHAGGRO2             = -1800002,
    SAY_WORGRAGGRO3             = -1800003,
    SAY_WORGRAGGRO4             = -1800004,
    SAY_RANDOMAGGRO             = -1800005,
    SAY_VICTORY1                = -1800006,
    SAY_VICTORY2                = -1800007,
    SAY_VICTORY3                = -1800008,
    SAY_VICTORY4                = -1800009,
    TEXT_EMOTE_WP1              = -1800010,
    TEXT_EMOTE_AGGRO            = -1800011,
    SAY_QUEST_ACCEPT            = -1800012,
    SAY_QUEST_COMPLETE          = -1800013
};
...
enum eSkirmisher
{
    ...
    RANDOM_SAY_1             =  -1800044,
    RANDOM_SAY_2             =  -1800045,
    RANDOM_SAY_3             =  -1800046
};
