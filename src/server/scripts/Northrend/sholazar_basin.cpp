        ...
        void WaypointReached(uint32 waypointId)
        {
            ...
            switch (waypointId)
            {
                ...
                case 1:
                    ...
                    me->SummonGameObject(184743, 5918.33f, 5372.91f, -98.770f, 0, 0, 0, 0, 0, TEMPSUMMON_MANUAL_DESPAWN);
                ...
                case 8:
                    ...
                    me->SummonGameObject(184743, 5887.37f, 5379.39f, -91.289f, 0, 0, 0, 0, 0, TEMPSUMMON_MANUAL_DESPAWN);
                    me->HandleEmoteCommand(EMOTE_ONESHOT_LAUGH);
                    break;
                case 9:
        ...
        void HandleSendEvent(SpellEffIndex effIndex)
        {
            ...
            if (Unit* caster = GetCaster())
            {
                if (Creature* presence = caster->FindNearestCreature(NPC_PRESENCE, 50.0f))
                {
                    ...
                    presence->CastSpell(presence, SPELL_FREYA_DUMMY, true);
