...
enum eGurgthock
{
    ...
    SPELL_SHOCKWAVE                               = 55918,
    SPELL_BLAST_OF_AIR                            = 55912,
    SPELL_MAGMA_WAVE                              = 55916,

    SPELL_ORB_OF_WATER                             = 55888,
    SPELL_ORB_OF_STORMS                            = 55882,
    SPELL_BOULDER                                  = 55886,
    SPELL_ORB_OF_FLAME                             = 55872,
};
...
{
    {5754.692f, -2939.46f, 286.276123f, 5.156380f},
    {5762.054199f, -2954.385010f, 273.826955f, 5.108289f},
    {5776.855f, -2989.77979f, 272.96814f, 5.194f}
};

const Position AddSpawnPosition[] =
{
    {5722.487f, -3010.75f, 312.751648f, 0.478f},
    {5724.983f, -2969.89551f, 286.359619f, 0.478f},
    {5733.76025f, -3000.34644f, 286.359619f, 0.478f},
    {5739.8125f, -2981.524f, 290.7671f, 0.478f},
    {5742.101f, -2950.75586f, 286.2643f, 5.21f},
    {5743.305f, -3011.29736f, 290.7671f, 0.478f},
    ...
    {5797.32129f, -2955.26855f, 290.7671f, 3.53f},
    {5813.94531f, -2956.74683f, 286.359619f, 3.53f},
    {5816.85547f, -2974.476f, 290.7671f, 3.53f},
    {5820.30859f, -3002.83716f, 290.7671f, 3.53f},
    {5828.50244f, -2981.737f, 286.359619f, 3.53f},
    {5828.899f, -2960.15479f, 312.751648f, 3.53f},
};
...
public:
    ...
    struct npc_vladof_the_butcherAI  : public ScriptedAI
    {
        ...
        {
            events.ScheduleEvent(EVENT_BLOOD_BOIL, 2000);
