...
enum DruidSpells
{
    ...
    SPELL_KING_OF_THE_JUNGLE_R1           = 48492,
...
class spell_dru_tiger_s_fury : public SpellScriptLoader
{
    public:
        ...
        class spell_dru_tiger_s_fury_SpellScript : public SpellScript
        {
            ...
            void OnHit()
            {
                if (AuraEffect const* aurEff = GetHitUnit()->GetAuraEffectOfRankedSpell(SPELL_KING_OF_THE_JUNGLE_R1, EFFECT_1))
...
class spell_dru_enrage : public SpellScriptLoader
{
    public:
        ...
        class spell_dru_enrage_SpellScript : public SpellScript
        {
            ...
            void OnHit()
            {
                if (AuraEffect const* aurEff = GetHitUnit()->GetAuraEffectOfRankedSpell(SPELL_KING_OF_THE_JUNGLE_R1, EFFECT_0))
