...
/**class spell_pal_avenging_wrath_pvp : public SpellScriptLoader
{
	public:
		spell_pal_avenging_wrath_pvp() : SpellScriptLoader("spell_pal_avenging_wrath_pvp") { }
		
		class spell_pal_avenging_wrath_pvp_SpellScript : public SpellScript
		{
			PrepareSpellScript(spell_pal_avenging_wrath_pvp_SpellScript);
		...
		SpellScript* GetSpellScript() const
        {
            return new spell_pal_avenging_wrath_pvp_SpellScript();
        }
};**/
...
void AddSC_paladin_spell_scripts()
{
	...
	//new spell_pal_avenging_wrath_pvp();
}
