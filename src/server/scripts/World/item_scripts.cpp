    ...
    public:
        ...
        bool OnUse(Player* player, Item* /*item*/, SpellCastTargets const& /*targets*/)
        {
            ...
            if(cd_time <= 0)
            {
                ...
                if (urand(0, 99) < 50)
                {
                    player->TextEmote(" wirft sein |cff0070dd|Hitem:44430:0:0:0:0:0:0:0:80|h[Titansiegel von Dalaran]|h|r in die Luft.");
                    player->TextEmote(" fängt die Münze und sie zeigt Kopf!");
                    return true;
                }
                else
                {
                    player->TextEmote(" wirft sein |cff0070dd|Hitem:44430:0:0:0:0:0:0:0:80|h[Titansiegel von Dalaran]|h|r in die Luft.");
                    player->TextEmote(" fängt die Münze und sie zeigt Zahl!");
                    return true;
                }
            }
            else
